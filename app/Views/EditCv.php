            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Data CV</h6>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo $action ?>" method="POST">
                            <input name="id_cv" type="hidden" class="form-control" id="id_cv" value="<?php echo $dataCv->id_cv; ?>">

                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Nama</label>
                                    <input name="nama" type="text" class="form-control" id="nama" value="<?= (old('nama')) ? old('nama') : $cv['nama'] ?>" required>
                                </div><br></br>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Tanggal Lahir</label>
                                    <input name="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" value="<?= (old('tangga_lahir')) ? old('tangga_lahir') : $cv['tangga_lahir'] ?>" required>
                                </div><br></br>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Email</label>
                                    <input name="email" type="text" class="form-control" id="email" value="<?= (old('email')) ? old('email') : $cv['email'] ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Alamat</label>
                                    <input name="alamat" type="text" class="form-control" id="alamat" value="<?= (old('alamat')) ? old('alamat') : $cv['alamat'] ?>" required>
                                </div><br></br>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Agama</label>
                                    <input name="agama" type="text" class="form-control" id="agama" value="<?= (old('agama')) ? old('agama') : $cv['agama'] ?>" required>
                                </div><br></br>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Jenis Kelamin</label>
                                    <input name="jenis_kelamin" type="text" class="form-control" id="jenis_kelamin" value="<?= (old('jenis_kelamin')) ? old('jenis_kelamin') : $cv['jenis_kelamin'] ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Hobi</label>
                                    <input name="hobi" type="text" class="form-control" id="hobi" value="<?= (old('hobi')) ? old('hobi') : $cv['hobi'] ?>" required>
                                </div>
                            </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group col-md-5">
                            <label for="inputEmail4">Nama Pendidikan</label>
                            <input name="nama_pendidikan" type="text" class="form-control" id="nama_pendidikan" value="<?= (old('nama_pendidikan')) ? old('nama_pendidikan') : $cv['nama_pendidikan'] ?>" required>
                        </div>
                    </div>
                </div>
                <div class="form-col">
                    <div class="form-group col-md-5">
                        <label for="inputEmail4">Tempat Pendidikan</label>
                        <input name="tempat_pendidikan" type="text" class="form-control" id="tempat_pendidikan" value="<?= (old('tempat_pendidikan')) ? old('tempat_pendidikan') : $cv['tempat_pendidikan'] ?>" required>
                    </div>
                </div>
            </div>
            <div class="form-col">
                <div class="form-group col-md-5">
                    <label for="inputEmail4">Waktu Pendidikan</label>
                    <input name="waktu_pendidikan" type="year" class="form-control" id="waktu_pendidikan" value="<?= (old('waktu_pendidikan')) ? old('waktu_pendidikan') : $cv['waktu_pendidikan'] ?>" required>
                </div>
