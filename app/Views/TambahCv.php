            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Tambah Data CV</h6>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo $action ?>" method="POST">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    ...
                                    <input name="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" value="<?= old('tanggal_lahir'); ?>" required>
                                </div><br></br>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    ...
                                    <input name="agama" type="text" class="form-control" id="agama" value="<?= old('agama'); ?>" required>
                                </div><br></br>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Jenis Kelamin</label>
                                    <input name="jenis_kelamin" type="text" class="form-control" id="jenis_kelamin" value="<?= old('jenis_kelamin'); ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Hobi</label>
                                    <input name="hobi" type="text" class="form-control" id="hobi" value="<?= old('hobi'); ?>" required>
                                </div>
                            </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group col-md-5">
                            ...
                            <input name="nama_pendidikan" type="text" class="form-control" id="nama_pendidikan" value="<?= old('nama_pendidikan'); ?>" required>
                        </div>
                    </div>
                </div>
                <div class="form-col">
                    <div class="form-group col-md-5">
                        ...
                        <input name="tempat_pendidikan" type="text" class="form-control" id="tempat_pendidikan" value="<?= old('tempat_pendidikan'); ?>" required>
                    </div>
                </div>
            </div>
            <div class="form-col">
                <div class="form-group col-md-5">
                    ...
                    <input name="waktu_pendidikan" type="year" class="form-control" id="waktu_pendidikan" value="<?= old('waktu_pendidikan'); ?>" required>
                </div>
